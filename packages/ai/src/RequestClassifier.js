...
const DECISION_LETTER_KEYWORDS = [
    'decision letter',
    'rating decision',
    'they denied',
    'they approved',
...
const DOCUMENT_REVIEW_KEYWORDS = [
    'review my',
    'check my',
    'look at my',
    'buddy letter',
...
export const RequestClassifier = { classifyRequest };
//# sourceMappingURL=RequestClassifier.js.map